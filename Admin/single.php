<?php
	$id_product = $_GET['linkid']; 
	include("config.php");
 ?>
 <?php
 	$sql_detail = "SELECT * FROM Product WHERE ID ='$_GET[linkid]'";
						...
						<div class="col-md-9 single-grid">
							<div clas="single-top">
									...
									<div class="flexslider">
										<ul class="slides">
											<li data-thumb="images/si.jpg">
												<div class="thumb-image"> <img src="<?php echo $dong_detail['HinhAnh'] ?>" data-imagezoom="true" class="img-responsive"> </div>
											</li>
								...
								<div class="single-right simpleCart_shelfItem">
									<h4><?php echo $dong_detail['TenSP'] ?></h4>
									<div class="block">
										<div class="starbox small ghosting"> </div>
									</div>
									<p class="price item_price"><?php echo number_format($dong_detail['Gia']) . " " ."VNĐ" ?></p>
									<div class="description">
										<p><span>Mô tả : </span> <?php echo $dong_detail['MoTa'] ?></p>
									</div>
									...
									<div class="women">
										<span class="size"><?php echo $dong_detail['Size'] ?></span>
